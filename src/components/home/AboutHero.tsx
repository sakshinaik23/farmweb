...
export default function StayHero() {
  return (
    <section className="relative w-full h-[35vh] min-h-[320px] overflow-hidden bg-[#f8f6f2]">
      ...
      >
        <Image
          src="/images/stay-hero.jpg" // <-- Change to your stay section hero image
          alt="Stay at Vrindavan Farms"
          fill
          priority
