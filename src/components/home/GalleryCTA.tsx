    ...
    <section className="py-28 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {gallery.map((item, idx) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-black/30 flex items-end p-4 rounded-3xl">
        ...
        >
          <a
            href="/booking"
            className="font-oswald tracking-[0.2em] font-semibold inline-block mt-6 bg-green-800 hover:bg-green-700 text-white px-10 py-3 rounded-full text-sm shadow-lg transition-all duration-300"
          >
            BOOK YOUR STAY NOW
          </a>
        </motion.div>
